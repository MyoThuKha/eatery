            ...
            <div className="h-96 pr-8 overflow-scroll">
              {steps.map((each) => {
                return (
                  ...
                  >
                    <p className=" text-xs flip">
                      Step {steps.indexOf(each) + 1}
                    </p>
              ...
              <div className="listBox py-4 w-56 bg-white">
                ...
                <div>
                  <div className="flex items-center pb-1">
                    ...
                    <p className="pl-4">{dish.readyInMinutes} minutes</p>
                  </div>
                  ...
                  <div className="flex items-center pb-1">
                    ...
                    <p className="pl-4">{dish.servings} servings</p>
                  </div>
                  ...
                  <div className="flex items-center pb-1">
                    ...
                    <p className="pl-4">{dish.healthScore} scores</p>
                  </div>
                </div>
                {/* --info-- */}
